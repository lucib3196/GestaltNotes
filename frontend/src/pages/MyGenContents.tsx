        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="mb-4 flex items-center justify-between">
                ...
                <p className="text-sm text-text-muted">
                    Showing {(page - 1) * pageSize + 1}-{Math.min(page * pageSize, quizzes.length)} of{" "}
                    {quizzes.length}
                </p>
            </div>
                ...
                {visibleQuizzes.map((v, idx) => {
                    ...
                    return (
                        <section
                            ...
                            className="rounded-lg border border-border bg-surface p-4 shadow-soft/20 backdrop-blur-sm transition duration-base ease-base hover:border-border-strong sm:p-5"
                        >
                            <RenderMCQSingle
                                question={v}
